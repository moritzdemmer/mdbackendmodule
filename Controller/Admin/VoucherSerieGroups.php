...
class VoucherSerieGroups extends VoucherSerieGroups_parent
{
    ...
    {
        $oxuseridsql = "DELETE FROM oxobject2group WHERE oxgroupsid = 'oxidbirthdaychilds'";
        $oxuserresultSet = \OxidEsales\Eshop\Core\DatabaseProvider::getDb()->execute($oxuseridsql);
    }
